...
public class CustomMenu extends PaginatedMenu {

    public CustomMenu(PlayerMenuUtility playerMenuUtility) {
    ...
    public void handleMenu(InventoryClickEvent e) throws MenuManagerNotSetupException, MenuManagerException {
        ...
        if (e.getCurrentItem().getType().equals(Material.BARRIER)) {
            ...
            CustomCreationMenu.getChatAsync().put(player,"head");
            ...
            server.setMaterial(material.toString());
            MenuManager.openMenu(SettingsMainMenu.class, player);
        }
    }
    ...
    public void setMenuItems() {
        ...
        if(CustomCreationMenu.getChatAsync().containsKey(player)) {
